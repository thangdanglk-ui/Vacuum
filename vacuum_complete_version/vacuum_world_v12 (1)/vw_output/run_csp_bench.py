...
print("Bắt đầu chạy benchmark cho nhóm CSP (30 maps)...")
...
# Generate summary
summary = {}
for algo, runs in results["CSP"].items():
...
final_output = {
    "CSP_Summary": summary,
    "Detailed_Runs": results["CSP"]
}

output_file = r"C:\Users\T14 GEN2\Downloads\csp_benchmark.json"
